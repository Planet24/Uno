...
class Partie:
    ...
    def __init__(self, nom):
        ...
        self.pioche.extend(Jeu.listeJaune[1:])
        self.pioche.extend(Jeu.listeJaune[1:])
        #+ Jeu.listeJaune[2:] + Jeu.listeBleu[1:] + Jeu.listeBleu[2:] + Jeu.listeRouge[1:] + Jeu.listeRouge[2:]+ Jeu.listeVert[1:]+ Jeu.listeVert[2:]+ 6*'J+' + 6*'JS' + 6*'JR'+ 6*'B+' + 6*'BS' + 6*'BR'+ 6*'R+' + 6*'RS' + 6*'RR'+ 6*'V+' + 6*'VS' + 6*'VR'+ Jeu.listeNoir[0:-1]*4
        shuffle(self.pioche)
    ...
    def joueJoueurSud(self, pioche, pot, carteChoisie, indice): #cartechoisie = click
        ...
        if pot[-1] in Jeu.listeJaune:
            if carteChoisie in Jeu.listeJaune:
                ...
                print(self.listeJoueurs[0].main)
                print(pot)
                return """self.listeJoueurs[0] + " a posé "+ pot[-1]""", False
